              ...
              <div className="h-6 border border-paper/25 bg-paper/10 relative overflow-hidden rounded-full">
                ...
                >
                  <div className="h-full bg-highlight/60 relative overflow-hidden rounded-full">
                    ...
                    >
                      <svg viewBox="0 0 200 20" preserveAspectRatio="none" className="w-full h-full opacity-50">
                        <path
            ...
            <StaggerItem>
              <div className="border border-paper/20 p-8 md:p-10 h-full space-y-8 bg-paper/5 backdrop-blur-sm">
                ...
                <div className="space-y-4">
                  {steps.map((step, i) => (
                    <div key={i} className="flex gap-4 items-start border-b border-dashed border-paper/20 pb-4">
                      <span className="font-serif-display italic text-paper/30 text-xl shrink-0 w-6">{i + 1}</span>
                      <p className="text-paper/80 leading-relaxed">
                        {i === 3 ? (
                          <>
                            For recipient, input:{" "}
                            <a href="mailto:give2torch@winontario.org" className="text-paper underline underline-offset-2 hover:text-highlight transition-colors">
                          ...
                          <>
                            ...
                            <span className="font-mono bg-paper/10 px-2 py-0.5 text-paper font-bold">PC26</span>
                          </>
                        ) : (
                          step
                        )}
            ...
            <StaggerItem>
              <div className="border border-paper/20 p-8 md:p-10 h-full flex flex-col justify-between space-y-8 bg-paper/5 backdrop-blur-sm">
                <div>
                  ...
                  <h3 className="font-serif-display text-3xl md:text-4xl text-paper">Give Online</h3>
                ...
                <div className="space-y-4">
                  ...
                  <p className="text-xs text-paper/40 text-center uppercase tracking-[0.15em]">Secure online giving</p>
                </div>
              </div>
            </StaggerItem>
          </StaggerReveal>
